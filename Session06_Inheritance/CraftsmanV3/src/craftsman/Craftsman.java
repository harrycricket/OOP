...
public class Craftsman {
    ...
    public static void playWithTriangle() {
        ...
        // Con new Con, gọi tên object đúng nó
        ...
        // Khai báo gì thì phải hành xử như thế vì mình đặt tên object kèm data type
        // object sẽ thuộc nhóm gì, theo Khuôn, theo Khuôn nhìn hành xử
        // lúc chạy thì chạy theo của Con vì override
    ...
    public static void playWithSquare() {
        ...
        // HV là HCN, hù theo kế thừa dòng họ
